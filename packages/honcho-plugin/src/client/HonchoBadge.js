...
export function HonchoBadge() {
    ...
    return (_jsxs("span", { "data-testid": "honcho-badge", title: `Honcho: ${state}`, className: "inline-flex items-center gap-1 px-1.5 py-[1px] rounded font-mono text-[10px]", 
        ...
        style: { background: bg, color: fg, verticalAlign: "middle" }, children: [_jsx(Icon, { path: mdiBrain, size: 0.6 }), _jsx("span", { children: state })] }));
}
//# sourceMappingURL=HonchoBadge.js.map
...
| `MobileShell.tsx` | Two-panel mobile shell with `useSwipeBack`. Flexes into remaining height beneath App banners; no independent viewport height. Depth 0=list, 1=detail, 2=preview. Exports `MobileShell`. |

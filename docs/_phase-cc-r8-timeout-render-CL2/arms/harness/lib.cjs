// CC-r7 NEW-IDENTITY shared harness lib. Isolated loopback 8157/8158, staged
...
const WS_URL = "ws://127.0.0.1:8157/ws";
const WS = "/tmp/build1-ccr8-cand-8157";
const MARKER = "build1-ccr8-cand-8157";
const SESS = path.join(WS, "state/.pi/agent/sessions");
const SECRET = process.env.C2_SECRET || "ccr8-multiop-secret-8157";
